...
| P2-1-2 | Claude Agent SDK プロバイダー実装   | 必須   | P2-1-1 | [ ]  |
| P2-1-3 | Codex SDK プロバイダー実装          | 必須   | P2-1-1 | [ ]  |
| P2-1-4 | Copilot SDK プロバイダー実装        | 必須   | P2-1-1 | [ ]  |
| P2-1-5 | Geminiプロバイダー実装 (API Key)    | 必須   | P2-1-1 | [ ]  |
| P2-1-6 | Ollamaプロバイダー実装 (ローカル)   | 必須   | P2-1-1 | [ ]  |

**注**: Claude / Codex / Copilot SDKはツール使用・マルチターン処理をサポート。
