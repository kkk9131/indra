...
| ID     | タスク                              | 重要度 | 依存   | 状態 |
| ------ | ----------------------------------- | ------ | ------ | ---- |
| P2-1-1 | LLMプロバイダーインターフェース設計 | 必須   | P1-4-3 | [x]  |
| P2-1-2 | Anthropic SDK プロバイダー実装      | 必須   | P2-1-1 | [x]  |
| P2-1-3 | OpenAI SDK プロバイダー実装         | 必須   | P2-1-1 | [x]  |
| P2-1-4 | Copilot SDK プロバイダー実装        | 必須   | P2-1-1 | [ ]  |
| P2-1-5 | Geminiプロバイダー実装 (API Key)    | 必須   | P2-1-1 | [x]  |
| P2-1-6 | Ollamaプロバイダー実装 (ローカル)   | 必須   | P2-1-1 | [x]  |

**注**: 設定管理（ConfigManager）とGateway統合も実装済み。

### P2-2: ストリーミング対応

| ID     | タスク                       | 重要度 | 依存   | 状態 |
| ------ | ---------------------------- | ------ | ------ | ---- |
| P2-2-1 | ストリーミングプロトコル拡張 | 必須   | P2-1-2 | [x]  |
