...
| P2-1-3 | OpenAIプロバイダー実装 (API Key)    | 必須   | P2-1-1 | [ ]  |
| P2-1-4 | Geminiプロバイダー実装 (API Key)    | 必須   | P2-1-1 | [ ]  |
| P2-1-5 | Ollamaプロバイダー実装 (ローカル)   | 必須   | P2-1-1 | [ ]  |

**注**: Claude Agent SDK はツール使用・マルチターン処理をサポート。
